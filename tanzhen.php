...
$requirements = array(
    array(
        'PHP 版本',
        true,
        version_compare(PHP_VERSION, "5.3.0", ">=") && version_compare(PHP_VERSION, "7.3.0", "<") ,
        'PHP 5.3 ~ 7.2',
        PHP_VERSION,
    ),
	array(
...
#checkcaiji b{color:red}
        ...
        <div style="width: 682px; margin: 10px auto">
			...
			<hr color="#ccc" size=1>
            <h4>检查结果</h4>
            <p>您的PHP版本是：<?php echo PHP_VERSION;?>，<?php echo $_SERVER['SERVER_SOFTWARE'];?>, 操作系统： <?php echo $php_os[0].'&nbsp;内核版本：'.(('/'==DIRECTORY_SEPARATOR)?$php_os[2]:$php_os[1]);?></p>
            <p>
                <?php if ($result > 0): ?>
